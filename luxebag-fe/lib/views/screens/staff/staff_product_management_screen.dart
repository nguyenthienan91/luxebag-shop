...
class StaffProductManagementScreen extends StatefulWidget {
  const StaffProductManagementScreen({super.key});

  @override
  State<StaffProductManagementScreen> createState() => _StaffProductManagementScreenState();
}

class _StaffProductManagementScreenState extends State<StaffProductManagementScreen> {
  ...
  void _deleteProduct(BuildContext context, ProductModel product) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Bạn có chắc chắn muốn xóa sản phẩm "${product.title}"? Thao tác này không thể hoàn tác.',
    ...
    return Scaffold(
      ...
      floatingActionButton: _showScrollToTop
          ...
          : FloatingActionButton(
              ...
              onPressed: () => context.push('/admin/product/new'),
              backgroundColor: AppColors.primary,
              foregroundColor: Colors.white,
              elevation: 4,
              shape: const CircleBorder(),
