  ...
  async sendVerificationOtpEmail(email: string, otp: string) {
    try {
      await this.resend.emails.send({
        from: 'LuxeBag <no-reply@thienantech.pro.vn>',
        to: email,
        subject: 'Mã xác thực tài khoản - LuxeBag',
        html: `
          <!DOCTYPE html>
          <html>
          <head><meta charset="UTF-8"></head>
              ...
              <tr><td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border:1px solid #e0e0e0;border-radius:8px;overflow:hidden;max-width:600px;">
                  ...
                  <tr>
                    <td style="background-color:#4f46e5;padding:24px 32px;text-align:center;">
                      <h1 style="margin:0;color:#ffffff;font-size:22px;letter-spacing:0.5px;">LuxeBag</h1>
                      <p style="margin:6px 0 0;color:#c7d2fe;font-size:13px;">Xác thực email đăng ký tài khoản</p>
                    </td>
                  </tr>
                  <!-- Body -->
                  <tr>
                    <td style="padding:32px;color:#333333;line-height:1.7;">
                      <h2 style="margin-top:0;color:#1e1b4b;font-size:18px;">Xác thực tài khoản LuxeBag của bạn</h2>
                      <p style="margin:12px 0;font-size:15px;">Xin chào,</p>
                      <p style="margin:12px 0;font-size:15px;">Cảm ơn bạn đã đăng ký tài khoản trên LuxeBag. Vui lòng sử dụng mã OTP dưới đây để hoàn tất việc xác thực địa chỉ email của bạn:</p>
                      <!-- OTP Box -->
                      <div style="margin: 28px 0; text-align: center;">
                        <span style="display:inline-block;padding:12px 36px;background-color:#f3f4f6;color:#1f2937;font-size:32px;font-weight:bold;letter-spacing:6px;border-radius:8px;border:1px solid #e5e7eb;">
                          ${otp}
                      ...
                      <hr style="border:none;border-top:1px solid #e5e7eb;margin:24px 0;" />
                      <p style="font-size:13px;color:#9ca3af;margin:0;">Nếu bạn không thực hiện yêu cầu đăng ký này, vui lòng bỏ qua email này.</p>
                    </td>
                  </tr>
                  <!-- Footer -->
                  <tr>
