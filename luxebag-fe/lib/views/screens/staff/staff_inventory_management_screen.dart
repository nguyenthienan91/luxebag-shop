...
class StaffInventoryManagementScreen extends StatefulWidget {
  const StaffInventoryManagementScreen({super.key});

  @override
  State<StaffInventoryManagementScreen> createState() => _StaffInventoryManagementScreenState();
}

class _StaffInventoryManagementScreenState extends State<StaffInventoryManagementScreen> {
